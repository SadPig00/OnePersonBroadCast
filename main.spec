...
a = Analysis(
    ...
    ('C:/Users/kangchul/PycharmProjects/OnePersonBroadcase/Assets/strikeZone2.png','./Assets'),
    ...
    ('C:/Users/kangchul/PycharmProjects/OnePersonBroadcase/Assets/NotoSans-Regular.ttf','./Assets'),
    ],
    hiddenimports=[],
    hookspath=[],
    hooksconfig={},
